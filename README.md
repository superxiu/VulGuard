...
### 安全性评估
![安全性评估](docs/screenshots/评估报告_带各种等级漏洞_1.png)
![安全性评估](docs/screenshots/评估报告_带各种等级漏洞_2.png)
![安全性评估](docs/screenshots/任务列表.png)
*对漏洞扫描结果进行安全性评估，评估报告包括漏洞危害等级分布图、危害等级和修复建议等内容*
